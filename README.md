...
安装时先将“图渡”拖入 Applications 文件夹。如果 macOS 提示“图渡已损坏”，可以双击 DMG 内的“打不开？双击修复”工具。该工具只移除 `/Applications/图渡.app` 的下载隔离标记，不会关闭系统安全功能、联网或修改其他应用；也可以选择由工具打开“隐私与安全性”设置后手动允许。
